...
!(function (t, e) {
  ...
  function e() {
    return (
      ...
      ("loading" !== document.readyState && !Ot.doScroll)
    );
  }
  function i(t) {
    var i = function () {
  ...
  function n(t, e, i, n) {
    void 0 === n && (n = !1),
      e.split(" ").forEach(function (e) {
        return F(t).addEventListener(e, i, n);
      });
  }
  function s(t, e, i, n) {
    void 0 === n && (n = !1),
      e.split(" ").forEach(function (e) {
        return F(t).removeEventListener(e, i, n);
      });
  }
  ...
  function r(t, e) {
    var i = p(e);
    return F(t).dispatchEvent(i), i;
  }
  function a(e, i, n, s) {
    void 0 === s && (s = !1);
    var o = i instanceof t.Event ? i : t.Event(i);
    return St(e)[s ? "triggerHandler" : "trigger"](o, n), o;
  }
  function l(t, e, i, n) {
    return (
      void 0 === i && (i = 400),
      ...
      C(function (s, o) {
        ...
        t.one(ie, function (e, i) {
          clearTimeout(a),
            t.removeClass("uk-transition").css("transition", ""),
            i ? o() : s();
        })
          .addClass("uk-transition")
          .css("transition", "all " + i + "ms " + n)
          .css(e);
      })
    );
  }
  function h(t, e, i, n, s) {
    ...
    var o = C(function (r) {
      ...
      (t = St(t)),
        0 === e.lastIndexOf("uk-animation-", 0) &&
          (n && (l += " uk-animation-" + n),
          s && (l += " uk-animation-reverse")),
        a(),
        t
          .one(se || "animationend", function () {
            o.then(a), r();
          })
  ...
  function u(t, e) {
    return (
      !!(t = St(t)).is(e) || (N(e) ? t.parents(e).length : F(e).contains(t[0]))
    );
  }
  function d(t, e, i, n) {
    return (t = St(t)).attr(e, function (t, e) {
      return e ? e.replace(i, n) : e;
    });
  }
  function f(t, e) {
    return d(t, "class", new RegExp("(^|\\s)" + e + "(?!\\S)", "g"), "");
  }
  function p(t, e, i, n) {
    if (
      (void 0 === e && (e = !0),
  ...
  function g(t, e, i) {
    ...
    var n = F(t).getBoundingClientRect();
    return (
      n.bottom >= -1 * e &&
      n.right >= -1 * i &&
      n.top <= window.innerHeight + e &&
      n.left <= window.innerWidth + i
    );
  }
  function m(t) {
    var e = 0;
  ...
  function v() {
    return Math.max(Ot.offsetHeight, Ot.scrollHeight);
  }
  function w(t, e, i) {
    void 0 === i && (i = 0), (e = St(e));
    var n = St(e).length;
  ...
  function b(t) {
    return Ht[F(t).tagName.toLowerCase()];
  }
  function y(t, e) {
    var i = H(t);
    return i
  ...
  function q(e) {
    return Lt(e)
      ...
      ? e.split(",").map(function (e) {
          return t.isNumeric(e) ? L(e) : z(e.trim());
        })
      : [e];
  }
  function W(t) {
  ...
  function X() {}
  function Q(t, e, i) {
    return (window.getComputedStyle(F(t), i) || {})[e];
  }
  function J(t) {
    var e,
    ...
    try {
      (e = Q(n, "content", ":before").replace(/^["'](.*)["']$/, "$1")),
        (e = JSON.parse(e));
    } catch (t) {}
  ...
  function Z() {
    oe.scheduled || ((oe.scheduled = !0), Vt(oe.flush.bind(oe)));
  }
  function K(t) {
  ...
  function nt(t, e) {
    ...
    var n,
      s = {};
    if (e.mixins)
      for (var o = 0, r = e.mixins.length; o < r; o++) t = nt(t, e.mixins[o]);
    for (n in t) i(n);
    for (n in e) k(t, n) || i(n);
    return s;
  }
  function st(t, e) {
    try {
      t.contentWindow.postMessage(
        JSON.stringify(Rt({ event: "command" }, e)),
        "*"
      );
    } catch (t) {}
  }
  ...
  function rt(e, i, n, s, o, r, a, l) {
    (n = dt(n)), (s = dt(s));
    var h = { element: n, target: s };
    if (!e) return h;
    var c = at(e),
      u = at(i),
      d = u;
    return (
      ut(d, n, c, -1),
      ut(d, s, u, 1),
      (o = ft(o, c.width, c.height)),
      (r = ft(r, u.width, u.height)),
      (o.x += r.x),
      (o.y += r.y),
      (d.left += o.x),
      (d.top += o.y),
      ...
      a &&
        t.each(pe, function (t, e) {
          ...
          var r = e[0],
            ...
            p = e[2];
          if (!0 === a || ~a.indexOf(t)) {
            var g = n[t] === f ? -c[r] : n[t] === p ? c[r] : 0,
              m = s[t] === f ? u[r] : s[t] === p ? -u[r] : 0;
            if (d[f] < l[f] || d[f] + c[r] > l[p]) {
              var v = c[r] / 2,
                w = "center" === s[t] ? -u[r] / 2 : 0;
              ("center" === n[t] && (i(v, w) || i(-v, -w))) || i(g, m);
            }
          }
        }),
      lt(e, d),
  ...
  function lt(t, e) {
    var i = e.left,
      n = e.top;
    St(t).offset({ left: i - ge.clientLeft, top: n - ge.clientTop });
  }
  function ht(t) {
    return (t = F(t)).getBoundingClientRect().top + ct(t).pageYOffset;
  }
  function ct(t) {
    return t && t.ownerDocument ? t.ownerDocument.defaultView : window;
  }
  function ut(e, i, n, s) {
    t.each(pe, function (t, o) {
      var r = o[0],
        a = o[1],
        l = o[2];
      i[t] === l
        ? (e[a] += n[r] * s)
        : "center" === i[t] && (e[a] += (n[r] * s) / 2);
    });
  }
  function dt(t) {
  ...
  function ft(t, e, i) {
    return (
      ...
      {
        x: t[0]
          ? parseFloat(t[0]) * ("%" === t[0][t[0].length - 1] ? e / 100 : 1)
          : 0,
        y: t[1]
          ? parseFloat(t[1]) * ("%" === t[1][t[1].length - 1] ? i / 100 : 1)
          : 0,
      }
    );
  }
  ...
  function gt(t) {
    var e = t.x1,
      ...
      n = t.y1,
      s = t.y2;
    return Math.abs(e - i) >= Math.abs(n - s)
      ? e - i > 0
        ? "Left"
        : "Right"
      : n - s > 0
  ...
  function vt(t) {
    return ve || "touch" === (t.originalEvent || t).pointerType;
  }
  function wt(t) {
    It.on(
      ((e = {}),
      (e["click." + t] = function (t) {
        xe &&
          xe.bgClose &&
            ...
            i.total <= 0 &&
              ...
              this.units.forEach(function (e) {
                ...
                if (((n = n.length < 2 ? "0" + n : n), t[e].text() !== n)) {
                  var s = t[e];
                  (n = n.split("")).length !== s.children().length &&
                    s.empty().append(
                      n
                        .map(function () {
                          return "<span></span>";
  ...
  function $t(t) {
    function e(t, e, i, n, o, r) {
      var a = (t = t in w ? w[t] : w.slide).show(o);
      return {
        dir: o,
        current: i,
        next: n,
        show: function (t, s) {
          ...
          return (
            ...
            this.translate(s),
            g
              .all([v.start(i, a[0], t, e), v.start(n, a[1], t, e)])
              .then(function () {
                o.reset(), r();
              }, l)
          );
        ...
        stop: function () {
          return g.all([v.stop(n), v.stop(i)]);
        },
        cancel: function () {
          return g.all([v.cancel(n), v.cancel(i)]);
        },
        reset: function () {
          for (var t in a[0]) s([n[0], i[0]]).css(t, "");
        },
        forward: function (t) {
          var e = this,
            s = this.percent();
          return g.all([v.cancel(n), v.cancel(i)]).then(function () {
            return e.show(t, s);
          });
        },
    ...
    if (!$t.installed) {
      ...
      t.mixin.slideshow = {
        ...
        events: [
          {
            ...
            handler: function (t) {
              t.preventDefault(),
                this.show(s(t.currentTarget).blur().attr(this.attrItem));
            },
          },
          {
            name: u,
        ...
        methods: {
            ...
            if (!((t.button && 0 !== t.button) || this.slides.length < 2)) {
              ...
              if (this.stack.length) {
                ...
                (e = this.percent * i),
                  ...
                  this._animation.translate(Math.abs(e)),
                  (this.index = this.getIndex(this.index - i)),
                  (this.touching = !0);
              }
              h(o, d, this.move, !0), h(o, f, this.end, !0);
          ...
          move: function (n) {
            ...
            if (
              !(
                ...
                (!this.touching && Math.abs(r - this.pos) < this.threshold)
              )
            ) {
              this.touching = !0;
              var c = (this.pos - r) / h.outerWidth();
              if (this.percent !== c) {
                var u = i(this.percent) !== i(c),
                  d = this.getIndex(this.index - i(c)),
                  f = this.slides.eq(d),
                  p = c < 0 ? 1 : -1,
                  g = a(c < 0 ? "next" : "previous", this.slides, d),
                  m = this.slides.eq(g);
                this.slides.each(function (t, e) {
                  return s.$toggleClass(e, s.clsActive, t === d || t === g);
                }),
                  u && this._animation && this._animation.reset(),
                  ...
                  this._animation.translate(Math.abs(c % 1)),
                  (this.percent = c),
                  t.update(null, f),
                  t.update(null, m);
              }
            ...
            if (
              ...
              (this.percent = Math.abs(this.percent) % 1),
                (this.index = this.getIndex(this.index - i(e))),
                this.percent < 0.2 &&
                  ((this.index = this.getIndex(e > 0 ? "previous" : "next")),
                  (this.percent = 1 - this.percent),
                  (e *= -1)),
                this.show(e > 0 ? "previous" : "next", !0),
                p();
            }
            this.pos =
              this.prevPos =
                ...
                var o = this.slides.hasClass("uk-active"),
                  a =
                    "next" === i
                      ...
                      ? -1
                      : 1;
                if (((i = this.getIndex(i)), o && i === this.index))
                  this.stack[n ? "shift" : "pop"]();
                else {
                  var l = o && this.slides.eq(this.index),
                    h = this.slides.eq(i);
                  this.$el.trigger("beforeitemshow", [this, h]),
                    l && this.$el.trigger("beforeitemhide", [this, l]),
                    (this.index = i),
                    this.$addClass(h, this.clsActive),
                    (this._animation = new e(
                      l ? this.animation : "scale",
                      this.transition,
                      l || h,
                      h,
                      a,
                      function () {
                        l && s.$removeClass(l, s.clsActive),
                          s.stack.shift(),
                          s.stack.length
                            ? m(function () {
                            ...
                            : (s._animation = null),
                          s.$el.trigger("itemshown", [s, h]),
                          t.update(null, h),
                          l &&
                            (s.$el.trigger("itemhidden", [s, l]),
                            t.update(null, l));
                      }
                    )),
                    ...
                    this.$el.trigger("itemshow", [this, h]),
                    l &&
                      (this.$el.trigger("itemhide", [this, l]),
                      t.update(null, l)),
                    t.update(null, h),
                    r.flush();
                }
          ...
          getIndex: function (t) {
            return (
              void 0 === t && (t = this.index), a(t, this.slides, this.index)
            );
          },
      ...
      var w = {
        ...
        slide: {
          ...
          translate: function (t, e) {
            return [
              { transform: "translate3d(" + -100 * e * t + "%, 0, 0)" },
        ...
        scale: {
          ...
          translate: function (t) {
            var e = 1 - 0.2 * t,
              i = 0.8 + 0.2 * t;
            return [
              { opacity: 1 - t, transform: "scale3d(" + e + ", " + e + ", 1)" },
              { opacity: t, transform: "scale3d(" + i + ", " + i + ", 1)" },
            ];
          },
        },
        swipe: {
          show: function (t) {
            return t < 0
              ...
              : [
                  {
                    opacity: 0.3,
                    transform: "scale3d(0.8, 0.8, 1) translate3d(-20%, 0, 0)",
                    zIndex: -1,
                  },
          ...
          percent: function (t, e, i) {
            var n = i < 0 ? t : e,
              s = Math.abs(n.css("transform").split(",")[4] / n.outerWidth());
            return i < 0 ? s : 1 - s;
          },
          translate: function (t, e) {
            var i;
  ...
  function xt(t) {
    ...
    function i(t, e, i) {
      return (
        ...
        '" height="' +
        i +
        '" style="max-width: 100%; box-sizing: border-box;" uk-video uk-responsive></iframe>'
      );
    }
    if (!xt.installed) {
      t.use($t);
      ...
      t.component("lightbox", {
        ...
        computed: {
          toggles: function () {
            var t = this,
              e = o(this.toggle, this.$el);
            return (
              (this._changed =
                !this._toggles ||
                e.length !== this._toggles.length ||
                e.toArray().some(function (e, i) {
        ...
        events: [
          {
            ...
            handler: function (t) {
              t.preventDefault(),
                this.show(this.toggles.index(o(t.currentTarget).blur()));
            },
          },
        ],
        update: function () {
            ...
            return (this.panel =
              ...
              t.lightboxPanel({
                ...
                items: this.toggles.toArray().reduce(function (t, e) {
                  return (
                    t.push(
                      ["href", "caption", "type"].reduce(function (t, i) {
                        return (t["href" === i ? "source" : i] = d(e, i)), t;
                      }, {})
                    ),
                    t
                  );
        ...
        t.component("lightbox-panel", {
          ...
          computed: {
            container: function () {
              return o(
                (!0 === this.$props.container && t.container) ||
          ...
          created: function () {
            var t = this;
            this.$mount(o(this.template).appendTo(this.container)[0]),
              ...
              this.items.forEach(function (e, i) {
                return t.list.append(
                  '<li class="' + t.clsItem + " item-" + i + '"></li>'
                );
              });
          },
          events: [
            { name: g + " " + p + " keydown", handler: "showControls" },
            {
              name: "click",
              self: !0,
              handler: function (t) {
            ...
            },
            {
              ...
              handler: function () {
                this.$addClass(this.caption, "uk-animation-slide-bottom"),
                  this.toolbars.attr("hidden", !0),
                  this.nav.attr("hidden", !0),
                  this.showControls();
              },
            },
            {
            ...
            },
            {
              ...
              self: !0,
              handler: function () {
                this.$removeClass(u, this.clsPage);
              },
            },
            {
              name: "keydown",
            ...
            },
            {
              ...
              handler: function (t, e) {
                ...
                if ((this.setItem(e, "<span uk-spinner></span>"), r)) {
                  if ("image" === a || r.match(/\.(jp(e)?g|png|gif|svg)$/i))
                    f(r).then(
                      function (t) {
                        return s.setItem(
                          e,
                    ...
                    var h = o("<video controls playsinline uk-video></video>")
                      .on("loadedmetadata", function () {
                        return s.setItem(
                          e,
                          h.attr({
                            width: h[0].videoWidth,
                            height: h[0].videoHeight,
                          })
                        );
                      })
                      .on("error", function () {
                    ...
                    var c = n[1],
                      u = function (t, n) {
                        return (
                          void 0 === t && (t = 640),
                          void 0 === n && (n = 450),
                          s.setItem(e, i("//www.youtube.com/embed/" + c, t, n))
                        );
                      };
                    f("//img.youtube.com/vi/" + c + "/maxresdefault.jpg").then(
                      function (t) {
                        120 === t.width && 90 === t.height
                          ? f("//img.youtube.com/vi/" + c + "/0.jpg").then(
                              function (t) {
                                return u(t.width, t.height);
                              },
                              u
                            )
                          : u(t.width, t.height);
                    ...
                    l({
                      ...
                      return s.setItem(
                        e,
                        i("//player.vimeo.com/video/" + n[2], r, o)
                      );
                    });
                  }
                  return !0;
          ...
          methods: {
            ...
            hide: function () {
              this.isToggled() && this.toggleNow(this.$el, !1),
                this.slides.removeClass(this.clsActive).each(function (t, e) {
                  return m.stop(e);
                }),
                delete this.index,
                delete this.percent,
            ...
            showControls: function () {
              clearTimeout(this.controlsTimer),
                ...
                this.toolbars.attr("hidden") &&
                  (e(this.toolbars.eq(0), "uk-animation-slide-top"),
                  e(this.toolbars.eq(1), "uk-animation-slide-bottom"),
                  this.nav.attr("hidden", this.items.length <= 1),
                  this.items.length > 1 && e(this.nav, "uk-animation-fade"));
            },
            hideControls: function () {
              this.toolbars.attr("hidden") ||
                (e(this.toolbars.eq(0), "uk-animation-slide-top", "out"),
                e(this.toolbars.eq(1), "uk-animation-slide-bottom", "out"),
                this.items.length > 1 &&
                  e(this.nav, "uk-animation-fade", "out"));
            },
          },
        });
    }
    ...
    if (!kt.installed) {
      ...
      t.component("notification", {
        ...
        events:
          ((l = {
            click: function (t) {
              i(t.target).closest('a[href="#"]').length && t.preventDefault(),
                this.close();
            },
          }),
          (l[s] = function () {
        ...
        methods: {
          close: function (t) {
            var e = this,
              i = function () {
                e.onClose && e.onClose(),
                  e.$el.trigger("close", [e]).remove(),
                  a[e.pos].children().length || a[e.pos].hide();
              };
            this.timer && clearTimeout(this.timer),
              t
                ? i()
        ...
        methods: {
          init: function (t) {
            ...
            !i.length ||
              ...
              (this.placeholder = i),
              (this.origin = o(
                { target: e, index: this.placeholder.index() },
                this.pos
              )),
              r.on(p, this.move),
              r.on(g, this.end),
              w.on("scroll", this.scroll),
              this.threshold || this.start(t));
          },
          start: function (e) {
            (this.drag = s(
              this.placeholder[0].outerHTML
                .replace(/^<li/i, "<div")
                .replace(/li>$/i, "div>")
            )
              .attr("uk-no-boot", "")
              ...
              this.drag
                .children()
                .first()
                .height(this.placeholder.children().height());
            var i = h(this.placeholder),
              n = i.left,
              a = i.top;
            o(this.origin, { left: n - this.pos.x, top: a - this.pos.y }),
              this.placeholder.addClass(this.clsPlaceholder),
              this.$el.children().addClass(this.clsItem),
              r.addClass(this.clsDragState),
          ...
          move: function (t) {
            if (this.drag) {
              ...
              if (
                n &&
                !c(i, this.placeholder) &&
                (!r || (n.group && n.group === o.group))
              ) {
                if (
                  ((i =
                    (n.$el.is(i.parentNode) && s(i)) ||
                    n.$el.children().has(i)),
                  r)
                )
                ...
                n.insert(this.placeholder, i),
                  ~this.touched.indexOf(n) || this.touched.push(n);
              }
            } else
          ...
          scroll: function () {
            ...
            if (
              (r.off(p, this.move),
              r.off(g, this.end),
              w.off("scroll", this.scroll),
              this.drag)
            ) {
              m();
              var i = e(this.placeholder[0]);
              this === i
                ? this.origin.index !== this.placeholder.index() &&
                  this.$el.trigger("change", [this, this.placeholder, "moved"])
                : (i.$el.trigger("change", [i, this.placeholder, "added"]),
              ...
              "mouseup" !== t.type &&
                c(t.target, "a[href]") &&
                (location.href = s(t.target).closest("a[href]").attr("href"));
          },
          insert: function (t, e) {
            var i = this;
            this.$el.children().addClass(this.clsItem);
            var n = function () {
              e.length
                ? !i.$el.has(t).length || t.prevAll().filter(e).length
                  ? t.insertBefore(e)
                  : t.insertAfter(e)
                : i.$el.append(t);
            };
          ...
          animate: function (t) {
            ...
            v.all(
              ...
              e.$el.css("min-height", "").children().css(r),
                e.$update("update", !0),
                l.flush();
            });
          },
  ...
  function _t(t) {
    if (!_t.installed) {
      ...
      t.component("tooltip", {
        ...
        methods: {
          show: function () {
            ...
            ~d.indexOf(this) ||
              ...
              d.push(this),
              s.on("click." + this.$options.name, function (e) {
              ...
              (this.origin =
                "y" === this.getAxis()
                  ? r(this.dir) + "-" + this.align
                  : this.align + "-" + r(this.dir)),
          ...
          hide: function () {
            ...
            !~t ||
              (this.$el.is("input") &&
                this.$el[0] === document.activeElement) ||
              (d.splice(t, 1),
              clearTimeout(this.showTimer),
        ...
        events:
          ((f = { blur: "hide" }),
          (f["focus " + c + " " + h] = function (t) {
            (t.type === h && a(t)) || this.show();
          }),
          (f[u] = function (t) {
            a(t) || this.hide();
          }),
      ...
      t.component("upload", {
        ...
        events: {
          ...
          drop: function (t) {
            ...
            e &&
              e.files &&
              (this.$removeClass(this.clsDragover), this.upload(e.files));
          },
          ...
          upload: function (t) {
            ...
            if (t.length) {
              ...
              for (var a = 0; a < t.length; a++) {
                if (n.allow && !e(n.allow, t[a].name))
                  return void n.fail(n.msgInvalidName.replace(/%s/, n.allow));
                if (n.mime && !e(n.mime, t[a].type))
                  return void n.fail(n.msgInvalidMime.replace(/%s/, n.mime));
              }
              this.multiple || (t = [t[0]]),
                this.beforeAll && this.beforeAll(this, t);
              var l = i(t, this.concurrent),
                h = function (t) {
                  var e = new FormData();
                  ...
                  o({
                    ...
                    complete: [
                      ...
                      function (t, e) {
                        l.length
                          ? h(l.shift())
                          : n.completeAll && n.completeAll(t),
                          "abort" === e && n.abort && n.abort(t);
                      },
                    ],
                    cache: !1,
                    contentType: !1,
                    ...
                    xhr: function () {
                      ...
                      return (
                        t.upload &&
                          n.progress &&
                          r(t.upload, "progress", n.progress),
                        [
                          "loadStart",
                          "load",
                          "loadEnd",
      ...
      t.component(
        ...
        t.components.grid.extend({
          ...
          computed: {
            ...
            items: function () {
              return (
                this.target ? this.$el.find(this.target) : this.$el.children()
              ).toArray();
            },
          },
          update: [
              ...
              write: function () {
                this.$el
                  ...
                  .css(
                    ...
                    this.columns > 1
                      ? this.translate +
                          parseFloat(this.$el.css("margin-bottom"))
                      : ""
                  );
              },
              events: ["load", "resize"],
            ...
            {
              read: function () {
                this.scrolled = i(this.$el) * this.translate;
              },
              write: function () {
                var t = this;
  ...
  function Et(t) {
    ...
    function i(t, e) {
      return +(
        h(t.diff) ? +t.end : t.start + t.diff * e * (t.start < t.end ? 1 : -1)
      ).toFixed(2);
    }
    if (!Et.installed) {
      var n = t.mixin,
      ...
      (n.parallax = {
        ...
        computed: {
          props: function () {
            var t = this;
            return d.reduce(function (i, n) {
              if (h(t.$props[n])) return i;
              ...
              var l,
                ...
                d = ~a.join("").indexOf("%") ? "%" : "px";
              if (s) {
                var f = t.$el[0].style.color;
                (t.$el[0].style.color = c),
                  (c = e(t.$el.css("color"))),
                  (t.$el[0].style.color = u),
                  (u = e(t.$el.css("color"))),
                  (t.$el[0].style.color = f);
              } else (c = parseFloat(c)), (u = parseFloat(u)), (l = Math.abs(c - u));
              if (
                ((i[n] = { start: c, end: u, diff: l, unit: d }),
                n.match(/^bg/))
              ) {
                ...
                (i[n].pos = t.$el
                  ...
                  .split(" ")["x" === n[2] ? 0 : 1]),
                  t.covers && o(i[n], { start: 0, end: c <= u ? l : -l });
              }
              return i;
            }, {});
          },
          ...
          covers: function () {
            return (
              "cover" ===
              this.$el.css("backgroundSize", "").css("backgroundSize")
            );
          },
        },
        disconnected: function () {
        ...
        update: [
          {
            read: function () {
              ...
              if (
                ...
                h(this._image) && this.covers && this.bgProps.length)
              ) {
                var e = this.$el
                  .css("backgroundImage")
                  .replace(/^none|url\(["']?(.+?)["']?\)$/, "$1");
                ...
                if (this._active) {
                  ...
                  this.bgProps.forEach(function (s) {
                    var o = t.props[s],
                      ...
                      c = o.pos,
                      u = o.diff,
                      d = "bgy" === s ? "height" : "width",
                      f = n[d] - i[d];
                    if (c.match(/%$/)) {
                      if (l >= h)
                        f < u
                          ? ((i[d] = n[d] + u - f), (t.props[s].pos = "0px"))
                          : ((c = ((-1 * f) / 100) * parseFloat(c)),
                            (c = r(c, u - f, 0)),
                            (t.props[s].pos = c + "px"));
                      else {
                        if (f < u) i[d] = n[d] + u - f;
                        else if ((f / 100) * parseFloat(c) > u) return;
                        t.props[s].pos = "-" + u + "px";
                      }
                      n = a.cover(e, i);
                    }
                ...
                switch (o) {
                  ...
                  case "y":
                    ...
                    var l = ["x", "y"].map(function (e) {
                      ...
                      h = l[0],
                      c = l[1];
                    e = s.transform += " translate3d(" + h + ", " + c + ", 0)";
                    break;
                  case "rotate":
                    s.transform += " rotate(" + a + "deg)";
                    break;
                  case "scale":
                    s.transform += " scale(" + a + ")";
                    break;
                    ...
                    s[o] =
                      ...
                      r.start
                        .map(function (e, i) {
                          return (
                            (e += t * (r.end[i] - e)),
                            3 === i ? parseFloat(e) : parseInt(e, 10)
                          );
                        })
                        .join(",") +
                      ")";
        ...
        t.component("parallax", {
          ...
          computed: {
            target: function () {
              return (
                (this.$props.target && u(this.$props.target, this.$el)) ||
                this.$el
              );
            },
          },
  ...
  var St = "default" in t ? t.default : t,
    Ot = document.documentElement,
    Dt = St(window),
    It = St(document),
    Nt = St(Ot),
    Bt = "rtl" === Ot.getAttribute("dir"),
    Mt = {
      start: l,
      stop: function (t, e) {
        return a(t, ie, [e], !0), C.resolve();
      },
      cancel: function (t) {
        return this.stop(t, !0);
      },
      inProgress: function (t) {
        return St(t).hasClass("uk-transition");
      },
    },
    Pt = {
      in: function (t, e, i, n) {
      ...
      inProgress: function (t) {
        return (
          St(t).hasClass("uk-animation-enter") ||
          St(t).hasClass("uk-animation-leave")
        );
      },
      cancel: function (t) {
        return (
          a(t, se || "animationend", null, !0),
          C(function (t) {
            return Vt(t);
          })
        );
  ...
  (C.resolve = function (t) {
    ...
    (C.all = function (t) {
      return Qt ? Promise.all(t) : St.when.apply(St, t);
    });
  var zt = /-(\w)/g,
    Lt = Array.isArray,
    qt = { "!": "closest", "+": "nextAll", "-": "prevAll" },
    Wt = {},
    Rt =
      Object.assign ||
      function (t) {
        ...
        for (var n = 0; n < e.length; n++) {
          var s = e[n];
          if (null !== s) for (var o in s) k(s, o) && (t[o] = s[o]);
        }
        return t;
      },
    Yt = window.MutationObserver || window.WebKitMutationObserver,
    Vt =
    ...
    Qt = "Promise" in window,
    Jt =
      "ontouchstart" in window ||
      (window.DocumentTouch && document instanceof DocumentTouch) ||
      (navigator.msPointerEnabled && navigator.msMaxTouchPoints) ||
      (navigator.pointerEnabled && navigator.maxTouchPoints),
    Gt = Jt ? "mousedown " + (Ut ? "touchstart" : "pointerdown") : "mousedown",
    Zt = Jt ? "mousemove " + (Ut ? "touchmove" : "pointermove") : "mousemove",
    Kt = Jt ? "mouseup " + (Ut ? "touchend" : "pointerup") : "mouseup",
    te = Jt && Xt ? "pointerenter" : "mouseenter",
    ee = Jt && Xt ? "pointerleave" : "mouseleave",
    ie = G("transition", "transition-end"),
    ne = G("animation", "animation-start"),
    se = G("animation", "animation-end"),
    oe = {
      reads: [],
      writes: [],
      measure: function (t) {
        return this.reads.push(t), Z(), t;
      },
      mutate: function (t) {
        return this.writes.push(t), Z(), t;
      },
      clear: function (t) {
        return tt(this.reads, t) || tt(this.writes, t);
      },
      flush: function () {
        K(this.reads),
          K(this.writes.splice(0, this.writes.length)),
          (this.scheduled = !1),
          (this.reads.length || this.writes.length) && Z();
      },
    };
  et.prototype = {
    positions: [],
      ...
      (this.handler = function (i) {
        e ||
          setTimeout(function () {
            ...
            s && n - t.positions[s - 1].time > 100 && t.positions.splice(0, s),
        ...
        It.on("mousemove", this.handler);
    },
    cancel: function () {
      this.handler && It.off("mousemove", this.handler);
    },
    movesTo: function (t) {
      ...
      return (
        e.right <= i.x ||
          (e.left >= i.x
            ...
            : e.bottom <= i.y
            ? s[0].reverse()
            : e.top >= i.y && s[1].reverse()),
        !!s.reduce(function (t, e) {
          return t + (it(n, e[0]) < it(i, e[0]) && it(n, e[1]) > it(i, e[1]));
        }, 0)
      );
    },
  };
  ...
  (re.args =
    ...
    re.destroy =
      function (t, e) {
        return (
          (t = t && !Lt(t) ? [t] : t),
          e ? (t ? t.concat(e) : Lt(e) ? e : [e]) : t
        );
      }),
    (re.update = function (t, e) {
      return re.args(t, S(e) ? { read: e } : e);
    }),
  ...
  var ae = function (t, e) {
    ...
    le = 0,
    he = function (t) {
      (this.id = ++le), (this.el = F(t));
    };
  (he.prototype.isVideo = function () {
    return this.isYoutube() || this.isVimeo() || this.isHTML5();
  }),
    (he.prototype.isHTML5 = function () {
      return "VIDEO" === this.el.tagName;
    }),
    (he.prototype.isIFrame = function () {
      return "IFRAME" === this.el.tagName;
    }),
    (he.prototype.isYoutube = function () {
      return (
        this.isIFrame() &&
        !!this.el.src.match(
    ...
    (he.prototype.isVimeo = function () {
      return this.isIFrame() && !!this.el.src.match(/vimeo\.com\/video\/.*/);
    }),
    (he.prototype.enableApi = function () {
      var t = this;
      ...
      var e,
        ...
        n = this.isVimeo();
      return i || n
        ? (this.ready = C(function (s) {
            o(t.el, "load", function () {
              if (i) {
                var n = function () {
                  return st(t.el, { event: "listening", id: t.id });
                };
              ...
              t.el.setAttribute(
                ...
                t.el.src +
                  (~t.el.src.indexOf("?") ? "&" : "?") +
                  (i ? "enablejsapi=1" : "api=1&player_id=" + le)
              );
          }))
        : C.resolve();
    }),
      ...
      this.isVideo() &&
        (this.isIFrame()
          ? this.enableApi().then(function () {
              return st(t.el, { func: "playVideo", method: "play" });
            })
    ...
    (he.prototype.pause = function () {
      ...
      this.isVideo() &&
        (this.isIFrame()
          ? this.enableApi().then(function () {
              return st(t.el, { func: "pauseVideo", method: "pause" });
            })
          : this.isHTML5() && this.el.pause());
    }),
    (he.prototype.mute = function () {
      var t = this;
      this.isVideo() &&
        (this.isIFrame()
          ? this.enableApi().then(function () {
              return st(t.el, { func: "mute", method: "setVolume", value: 0 });
            })
          : this.isHTML5() &&
            ((this.el.muted = !0), this.el.setAttribute("muted", "")));
    });
  var ce,
    ue,
    de,
    fe,
    pe = { x: ["width", "left", "right"], y: ["height", "top", "bottom"] },
  ...
  i(function () {
    n(
      ...
      n(document, Gt, function (t) {
        var e = t.touches ? t.touches[0] : t,
          i = e.target,
          n = e.pageX,
          s = e.pageY,
          o = Date.now();
        (me.el = "tagName" in i ? i : i.parentNode),
          ce && clearTimeout(ce),
          (me.x1 = n),
          (me.y1 = s),
          me.last && o - me.last <= 250 && (me = {}),
          (me.last = o),
          (fe = t.button > 0);
      }),
      n(document, Zt, function (t) {
        var e = t.touches ? t.touches[0] : t,
          i = e.pageX,
          n = e.pageY;
        (me.x2 = i), (me.y2 = n);
      }),
      n(document, Kt, function (t) {
        var e = t.target;
        (me.x2 && Math.abs(me.x1 - me.x2) > 30) ||
        (me.y2 && Math.abs(me.y1 - me.y2) > 30)
          ? (ue = setTimeout(function () {
              me.el && (r(me.el, "swipe"), r(me.el, "swipe" + gt(me))),
                (me = {});
            }))
          : "last" in me
          ? ((de = setTimeout(function () {
              return me.el && r(me.el, "tap");
            })),
            me.el &&
              u(e, me.el) &&
              (ce = setTimeout(function () {
                (ce = null), me.el && !fe && r(me.el, "click"), (me = {});
              }, 350)))
          : (me = {});
      }),
      n(document, "touchcancel", mt),
      n(window, "scroll", mt);
  });
  var ve = !1;
  n(
  ...
  var we,
    ...
    ye = Object.freeze({
      ...
      scrolledOver: function (t) {
        var e = (t = F(t)).offsetHeight,
          i = m(t),
          n = window.innerHeight,
          s = n + Math.min(0, i - n),
          o = Math.max(0, n - (v() - (i + e)));
        return U(
  ...
  ($e.util = ye),
    ...
    (function (t) {
      ...
      (t.use = function (t) {
        ...
        (t.mixin = function (e, i) {
          (i = (N(i) ? t.components[i] : i) || this),
            ((e = nt({}, e)).mixins = i.options.mixins),
            delete i.options.mixins,
            (i.options = nt(e, i.options));
        }),
        (t.extend = function (t) {
          var i = this,
        ...
        (t.update = function (e, o, r) {
          if ((void 0 === r && (r = !1), (e = p(e || "update")), o))
            if (((o = F(o)), r))
              do {
                n(o[s], e), (o = o.parentNode);
              } while (o);
            else
              i(o, function (t) {
                return n(t[s], e);
    ...
    (function (t) {
      (t.prototype._callHook = function (t) {
        ...
        (t.prototype._callConnected = function () {
          var e = this;
          this._connected ||
            (~t.elements.indexOf(this.$options.el) ||
        ...
        (t.prototype._callUpdate = function (t) {
          var e = this;
          "update" === (t = p(t || "update")).type && (this._computeds = {});
          var i = this.$options.update;
          i &&
            i.forEach(function (i, n) {
              ("update" === t.type ||
                (i.events && ~i.events.indexOf(t.type))) &&
                (i.read &&
                  !~oe.reads.indexOf(e._frames.reads[n]) &&
                  (e._frames.reads[n] = oe.measure(function () {
                    i.read.call(e, t), delete e._frames.reads[n];
                  })),
                i.write &&
                  !~oe.writes.indexOf(e._frames.writes[n]) &&
                  (e._frames.writes[n] = oe.mutate(function () {
    ...
    (function (t) {
      function e(t, e) {
        ...
        if (!o) return n;
        for (r in o)
          if (((a = T(r)), l.hasAttribute(a))) {
            var h = R(o[r], l.getAttribute(a), l);
            if ("target" === a && (!h || 0 === h.lastIndexOf("_", 0))) continue;
            n[r] = h;
          }
        var c = i($(l, e), s);
        for (r in c) void 0 !== o[(a = A(r))] && (n[a] = R(o[a], c[r], l));
        return n;
      }
      function i(t, e) {
        void 0 === e && (e = []);
      ...
      function n(t, e, i) {
        Object.defineProperty(t, e, {
          ...
          get: function () {
            return (
              k(t._computeds, e) || (t._computeds[e] = i.call(t)),
              t._computeds[e]
            );
          },
          set: function (i) {
      ...
      function s(t, e, i, n) {
        ...
        if (
          ...
          if (h && !h.call(t)) return;
          (c = N(c) ? t[c] : x(c, t)),
            l && (c = o(c, t)),
            a ? r.on(s, N(a) ? a : a.call(t), c) : r.on(s, c);
        }
      }
      function o(t, e) {
        return function (i) {
      ...
      function a(t, e) {
        return M(t) || t === e || (c(t) && c(e) && t.is(e));
      }
      var l = 0;
      (t.prototype.props = {}),
        (t.prototype._init = function (e) {
          (e = e || {}),
            (e = this.$options = nt(this.constructor.options, e, this)),
            (this.$el = null),
            (this.$name = t.prefix + T(this.$options.name)),
            (this.$props = {}),
        ...
        (t.prototype._initData = function () {
          ...
          s.length &&
            Lt(n) &&
            (n = n.slice(0, s.length).reduce(function (t, e, i) {
              return D(e) ? Rt(t, e) : (t[s[i]] = e), t;
            }, {}));
          for (var a in i)
            t.$props[a] = t[a] =
              k(n, a) && !M(n[a])
        ...
        (t.prototype._initProps = function (t) {
          var i = this;
          (this._computeds = {}),
            Rt(this.$props, t || e(this.$options, this.$name));
        ...
        (t.prototype._initEvents = function (t) {
          ...
          i &&
            i.forEach(function (i) {
              if (k(i, "handler")) s(e, t, i);
              else for (var n in i) s(e, t, i[n], n);
            });
        }),
        (t.prototype._initObserver = function () {
          ...
          !this._observer &&
            ...
            (this._observer = new Yt(function () {
    ...
    (function (t) {
      ...
      (t.prototype.$mount = function (t) {
        ...
        t[e] || (t[e] = {}),
          t[e][i] ||
            ((t[e][i] = this),
            (this.$options.el = this.$options.el || t),
            (this.$el = St(t)),
            this._initProps(),
            this._callHook("init"),
            document.documentElement.contains(t) && this._callConnected());
      }),
      ...
      (t.components = {}),
        ...
        (t.connect = function (i) {
          ...
          for (var s = 0; s < i.attributes.length; s++)
            (0 !== (n = i.attributes[s].name).lastIndexOf("uk-", 0) &&
              0 !== n.lastIndexOf("data-uk-", 0)) ||
              ((n = A(n.replace("data-uk-", "").replace("uk-", ""))),
              t[n] && t[n](i));
        }),
    ...
    (function (t) {
        ...
        return (
          ...
          t.forEach(function (e, i) {
            return (
              ...
              N(e) &&
              ~e.indexOf(" ") &&
              Array.prototype.splice.apply(t, [i, 1].concat(t[i].split(" ")))
            );
          }),
      ...
      (t.prototype.$addClass = function () {
        ...
        (t.prototype.$toggleClass = function () {
          ...
          for (
            var n =
                (t = i(t, this.$options.el)) && !N(t[t.length - 1])
                  ? t.pop()
                  : void 0,
              s = 1;
            s < (t && t.length);
            ...
            t[0] && be
              ? t[0].toggle(t[s], n)
              : t[0][(M(n) ? !t[0].contains(t[s]) : n) ? "add" : "remove"](
                  t[s]
                );
        });
    })($e);
  var xe,
    ...
    _e = {
      ...
      computed: {
        ...
        hasTransition: function () {
          return this.hasAnimation && !0 === this.animation[0];
        },
      },
      methods: {
        toggleElement: function (t, e, i) {
          ...
          return C(function (s) {
            var o,
              ...
              h = function (t) {
                var e = l(t);
                return (n._queued = null), (r.scrollTop = a), e;
              };
            return (
              (t = St(t)),
              !n.hasAnimation || !n.queued || t.length < 2
                ? l(t).then(s, X)
                : n._queued
                ? h(t.not(n._queued)).then(s, X)
                : ((n._queued = t.not(
        ...
        isToggled: function (t) {
          return (
            (t = (t && St(t)) || this.$el),
            this.cls ? t.hasClass(this.cls.split(" ")[0]) : !t.attr("hidden")
          );
        },
        updateAria: function (t) {
          !1 === this.cls && t.attr("aria-hidden", !this.isToggled(t));
        },
        _toggleElement: function (e, i, n) {
          var s = this;
          if (((e = St(e)), Pt.inProgress(e)))
            return Pt.cancel(e).then(function () {
              return s._toggleElement(e, i, n);
            });
          if (
            ((i = I(i) ? i : !this.isToggled(e)),
            !1 === a(e, "before" + (i ? "show" : "hide"), [this]).result)
          )
            return C.reject();
          var o = (
          ...
          return (
            ...
            a(e, r, [this]),
            o.then(function () {
              a(e, i ? "shown" : "hidden", [s]), $e.update(null, e);
            })
          );
        },
        _toggle: function (t, e) {
          (t = St(t)),
            this.cls
              ? t.toggleClass(this.cls, ~this.cls.indexOf(" ") ? void 0 : e)
              : t.attr("hidden", !e),
            t.find("[autofocus]:visible").focus(),
            this.updateAria(t),
            $e.update(null, t);
        },
        _toggleImmediate: function (t, e) {
          return this._toggle(t, e), C.resolve();
        },
        _toggleHeight: function (t, e) {
          var i,
            ...
            s = Mt.inProgress(t),
            o =
              parseFloat(t.children().first().css("margin-top")) +
              parseFloat(t.children().last().css("margin-bottom")),
            r = t[0].offsetHeight ? t.height() + (s ? 0 : o) : 0;
          return Mt.cancel(t).then(function () {
            return Mt.inProgress(t)
              ? C.resolve().then(function () {
                  return n._toggleHeight(t, e);
                })
              : (n.isToggled(t) || n._toggle(t, !0),
                t.height(""),
                oe.flush(),
                (i = t.height() + (s ? 0 : o)),
                t.height(r),
                e
                  ? Mt.start(
                      t,
                      Rt(n.initProps, { overflow: "hidden", height: i }),
                      Math.round(n.duration * (1 - r / i)),
                      n.transition
                    )
                  : Mt.start(
                      t,
                      n.hideProps,
                      Math.round(n.duration * (r / i)),
                      n.transition
                    ).then(function () {
                      n._toggle(t, !1), t.css(n.initProps);
                    }));
          });
        },
        _toggleAnimation: function (t, e) {
          ...
          return e
            ? (this._toggle(t, !0),
              Pt.in(t, this.animation[0], this.duration, this.origin))
            : Pt.out(
                t,
    ...
    Te = {
      ...
      computed: {
        ...
        container: function () {
          return F(
            (!0 === this.$props.container && $e.container) ||
              (this.$props.container && j(this.$props.container))
          );
        },
      ...
      events: [
        ...
        },
        {
          ...
          handler: function () {
            ...
            var e = xe && xe !== this && xe;
            if (((xe = this), (this.component.active = this), e)) {
            ...
            e ||
              ((this.scrollbarWidth = window.innerWidth - Nt[0].offsetWidth),
              this.body.css(
                "overflow-y",
                this.scrollbarWidth && this.overlay ? "scroll" : ""
              )),
              Nt.addClass(this.clsPage);
          },
        },
        {
          name: "beforehide",
      ...
      methods: {
        ...
        show: function () {
          var t = this;
          return this.container && !this.$el.parent().is(this.container)
        ...
        _toggleImmediate: function (t, e) {
          ...
          return (
            ...
            this.transitionDuration
              ? C(function (t, e) {
                  i._transition &&
                    (i.transitionElement.off(ie, i._transition.handler),
                    i._transition.reject()),
                    (i._transition = {
                      reject: e,
                      handler: function () {
                    ...
                    i.transitionElement.one(ie, i._transition.handler);
                })
              : C.resolve()
          );
        },
    ...
    Ae = {
      ...
      defaults: {
        pos: Bt ? "bottom-right" : "bottom-left",
        flip: !0,
        offset: !1,
        clsPos: "",
      },
      computed: {
        pos: function () {
          return (
            this.$props.pos + (~this.$props.pos.indexOf("-") ? "" : "-center")
          ).split("-");
        },
        dir: function () {
          return this.pos[0];
      ...
      methods: {
        positionAt: function (t, e, i) {
          f(t, this.clsPos + "-(top|bottom|left|right)(-[a-z]+)?").css({
            top: "",
            left: "",
          });
          var n = L(this.offset) || 0,
            s = this.getAxis(),
            o = rt(
              t,
              e,
              "x" === s
                ? pt(this.dir) + " " + this.align
                : this.align + " " + pt(this.dir),
              "x" === s
                ? this.dir + " " + this.align
                : this.align + " " + this.dir,
              "x" === s
          ...
          (this.dir = "x" === s ? o.target.x : o.target.y),
            (this.align = "x" === s ? o.target.y : o.target.x),
            t.toggleClass(
        ...
        events: [
          {
            ...
            handler: function (t) {
              t.preventDefault(),
                this.toggle(
                  this.items.find(this.$props.toggle).index(t.currentTarget)
                );
            },
          },
        ],
        update: function () {
          ...
          if (this.items.length && this._changed) {
            this.items.each(function (e, i) {
              (i = St(i)),
                t.toggleNow(i.find(t.content), i.hasClass(t.clsOpen));
            });
            var e =
              (!1 !== this.active && j(this.items.eq(Number(this.active)))) ||
              (!this.collapsible && j(this.items.eq(0)));
        ...
        methods: {
          toggle: function (t, e) {
            ...
            (t = this.items.eq(n))
              ...
              .each(function (n, o) {
                var r = (o = St(o)).is(t),
                  a = r && !o.hasClass(i.clsOpen);
                if (a || !r || i.collapsible || !(s.length < 2)) {
                  o.toggleClass(i.clsOpen, a);
                  var l = o[0]._wrapper
                    ? o[0]._wrapper.children().first()
                    : o.find(i.content);
                  o[0]._wrapper ||
                    (o[0]._wrapper = l
                      .wrap("<div>")
                      .parent()
                      .attr("hidden", a)),
                    i._toggleImmediate(l, !0),
                    i.toggleElement(o[0]._wrapper, a, e).then(function () {
                      o.hasClass(i.clsOpen) === a &&
                        (a || i._toggleImmediate(l, !1),
                        (o[0]._wrapper = null),
                        l.unwrap());
                    });
                }
    ...
    Se = function (t) {
      t.component("alert", {
        ...
        defaults: {
          ...
          duration: 150,
          hideProps: Rt({ opacity: 0 }, _e.defaults.hideProps),
        },
        events: [
          {
            name: "click",
    ...
    Oe = function (t) {
      t.component("cover", {
        ...
        ready: function () {
          ...
          var t = new he(this.$el);
          t.isVideo() && t.mute();
        },
        update: {
          write: function () {
            0 !== this.el.offsetHeight &&
              this.$el.css({ width: "", height: "" }).css(
                jt.cover(
                  {
    ...
    De = function (t) {
      function e() {
        n ||
          ((n = !0),
          It.on("click", function (t) {
            for (
              var e;
              i &&
              i !== e &&
              !u(t.target, i.$el) &&
              (!i.toggle || !u(t.target, i.toggle.$el));
      ...
      t.component("drop", {
        ...
        ready: function () {
          this.updateAria(this.$el),
            this.toggle &&
              (this.toggle = t.toggle(y(this.toggle, this.$el), {
                target: this.$el,
                mode: this.mode,
              }));
        },
          ...
          },
          {
            ...
            handler: function (t) {
              if (!t.isDefaultPrevented()) {
                var e = St(t.target).attr("href");
                1 === e.length && t.preventDefault(),
                  (1 !== e.length && u(e, this.$el)) || this.hide(!1);
              }
            },
          },
          {
            ...
            handler: function (t) {
              vt(t) ||
                (i &&
                  i !== this &&
                  i.toggle &&
                  ~i.toggle.mode.indexOf("hover") &&
                  !u(t.target, i.$el) &&
                  !u(t.target, i.toggle.$el) &&
                  i.hide(!1),
                t.preventDefault(),
          ...
          },
          {
            ...
            handler: function (t, e) {
              vt(t) ||
                ...
                (t.preventDefault(),
                this.toggle &&
                  ~this.toggle.mode.indexOf("hover") &&
                  this.hide());
            },
          },
          {
            ...
            handler: function (t) {
              ...
              this.$el.is(e)
                ? ((i = this.isActive() ? null : i),
                  ...
                  this.tracker.cancel())
                : (i =
                    null === i && u(e, this.$el) && this.isToggled()
                      ? this
                      : i);
            },
          },
        ...
        update: {
          write: function () {
            this.isToggled() && !Pt.inProgress(this.$el) && this.position();
          },
          events: ["resize"],
        },
        methods: {
                ...
                if (
                  ...
                  if (e && i && i !== n && i.isDelaying)
                    ...
                    if (n.isParentOf(i)) {
                      ...
                      for (var o; i && i !== o && !n.isChildOf(i); )
                        (o = i), i.hide(!1);
                    e && n.delayShow
                      ? (n.showTimer = setTimeout(s, n.delayShow))
                      : s(),
                      (i = n);
                  }
              };
            t && this.toggle && !this.toggle.$el.is(t.$el)
              ? (this.$el.one("hide", o), this.hide(!1))
              : o();
          },
          hide: function (t) {
            var e = this;
          ...
          isChildOf: function (t) {
            return t && t !== this && u(this.$el, t.$el);
          },
          isParentOf: function (t) {
            return t && t !== this && u(t.$el, this.$el);
          },
          position: function () {
            f(this.$el, this.clsDrop + "-(stack|boundary)").css({
              top: "",
              left: "",
            }),
              this.$el
                .show()
                .toggleClass(this.clsDrop + "-boundary", this.boundaryAlign);
            var t = at(this.boundary),
              e = this.boundaryAlign ? t : at(this.toggle.$el);
        ...
        events: [
          {
            ...
            handler: function (t) {
              ...
              this.state.toggleClass(
                "uk-" + (~e.indexOf("focus") ? "focus" : "hover"),
                ~["focusin", "mouseenter"].indexOf(e)
              );
            },
          },
          {
    ...
    Be = function (t) {
      t.component("gif", {
        update: {
          read: function () {
            var t = g(this.$el);
            !this.isInView && t && (this.$el[0].src = this.$el[0].src),
              (this.isInView = t);
          },
          events: ["scroll", "load", "resize"],
        },
            ...
            return (
              (t = t
                .each(function (t, n) {
                  var s, o, r;
                  0 === n.offsetHeight &&
                    ((o = (s = St(n)).attr("style") || null),
                    (r = s.attr("hidden") || null),
                    s.attr({
                      style: o + ";display:block !important;",
                      hidden: null,
                    })),
                    (e = Math.max(e, n.offsetHeight)),
                    i.push(n.offsetHeight),
                    s && s.attr({ style: o, hidden: r });
                })
                .filter(function (t) {
                  return i[t] < e;
                })),
        ...
        update: {
          write: function () {
            ...
            if (this.expand) {
              ...
              s > 0 &&
                this.$el.css("min-height", (e = this.$el.outerHeight() + s));
            } else {
              var o = ht(this.$el);
              if (
                (o < i / 2 && this.offsetTop && (n += o),
                !0 === this.offsetBottom)
              )
                n += this.$el.next().outerHeight() || 0;
              else if (t.isNumeric(this.offsetBottom))
                n += (i / 100) * this.offsetBottom;
              else if (
                this.offsetBottom &&
                "px" === this.offsetBottom.substr(-2)
              )
                n += parseFloat(this.offsetBottom);
              else if (N(this.offsetBottom)) {
                var r = y(this.offsetBottom, this.$el);
                n += (r && r.outerHeight()) || 0;
              }
              this.$el.css(
                "min-height",
                (e = n ? "calc(100vh - " + n + "px)" : "100vh")
              );
            }
            this.$el.height(""),
              e && i - n >= this.$el.outerHeight() && this.$el.css("height", e);
          },
          events: ["load", "resize"],
        },
      });
        ...
        if (Jt) {
          ...
          Nt.on("tap", function (t) {
            ...
            Object.defineProperty(t, "hoverSelector", {
              set: function (t) {
                Nt.on("tap", t, function (t) {
                  return t.currentTarget.classList.add(e);
                });
              },
            }),
            (t.hoverSelector =
    ...
    Fe = function (t) {
      ...
      var i = {},
        n = {
          ...
          "slidenav-next":
            '<svg width="11" height="20" viewBox="0 0 11 20" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.2" points="1 1 10 10 1 19"></polyline></svg>',
          "slidenav-next-large":
            '<svg width="18" height="34" viewBox="0 0 18 34" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.4" points="1 1 17 17 1 33"></polyline></svg>',
          "slidenav-previous":
            '<svg width="11" height="20" viewBox="0 0 11 20" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.2" points="10 1 1 10 10 19"></polyline></svg>',
          "slidenav-previous-large":
            '<svg width="18" height="34" viewBox="0 0 18 34" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" stroke="#000" stroke-width="1.4" points="17 1 1 17 17 33"></polyline></svg>',
        };
      t.component(
        "icon",
          ...
          methods: {
            getSvg: function () {
              ...
              return e
                ...
                : C.reject("Icon not found.");
            },
            getIcon: function () {
              return n[this.icon]
                ? (i[this.icon] || (i[this.icon] = this.parse(n[this.icon])),
                  i[this.icon])
                : null;
            },
          },
          ...
          return e(t, {
            init: function () {
              this.$addClass("uk-slidenav"),
                this.$hasClass("uk-slidenav-large") && (this.icon += "-large");
            },
          });
        }),
        e("search-icon", {
          init: function () {
            this.$hasClass("uk-search-icon") &&
            this.$el.parents(".uk-search-large").length
              ? (this.icon = "search-large")
              : this.$el.parents(".uk-search-navbar").length &&
        ...
        e("close", {
          init: function () {
            this.icon =
              "close-" + (this.$hasClass("uk-close-large") ? "large" : "icon");
          },
        }),
        e("spinner", {
          connected: function () {
    ...
    ze = function (t) {
      t.component("margin", {
        ...
        update: {
          read: function () {
            var t = this;
            if (this.items.length && 0 !== this.$el[0].offsetHeight) {
              this.stacks = !0;
              for (var e = [[]], i = 0; i < this.items.length; i++) {
                ...
                if (s.height)
                  for (var o = e.length - 1; o >= 0; o--) {
                    ...
                    if (s.top >= Math.floor(a.bottom)) {
                      e.push([n]);
                      break;
                    }
                    if (Math.floor(s.bottom) > a.top) {
                      if (((t.stacks = !1), s.left < a.left && !Bt)) {
                        r.unshift(n);
                        break;
                      }
                      r.push(n);
            ...
            this.rows &&
              this.rows.forEach(function (e, i) {
                return e.forEach(function (e, n) {
                  t.$toggleClass(e, t.margin, 0 !== i),
                    t.$toggleClass(e, t.firstColumn, 0 === n);
                });
              });
          },
          events: ["load", "resize"],
    ...
    Le = function (t) {
      t.component("modal", {
        ...
        events: [
          {
            ...
            self: !0,
            handler: function () {
              this.panel.hasClass("uk-margin-auto-vertical")
            ...
            write: function () {
              ...
              this.$el
                ...
                .css(
                  ...
                  Math.max(
                    150,
                    150 + this.modal.height() - this.panel.outerHeight(!0)
                  )
                ),
        ...
        (t.modal.alert = function (e, i) {
          return (
            (i = Rt({ bgClose: !1, escClose: !1, labels: t.modal.labels }, i)),
            C(function (n) {
              return t.modal
                .dialog(
          ...
          return (
            ...
            C(function (n, s) {
              return t.modal
                ...
                .$el.on("click", ".uk-modal-footer button", function (t) {
                  return 0 === St(t.target).index() ? s() : n();
                });
            })
          );
        }),
        (t.modal.prompt = function (e, i, n) {
          return (
            (n = Rt({ bgClose: !1, escClose: !1, labels: t.modal.labels }, n)),
            C(function (s) {
              var o = !1,
                r = t.modal.dialog(
                  '<form class="uk-form-stacked"><div class="uk-modal-body"><label>' +
                    (N(e) ? e : St(e).html()) +
                    '</label><input class="uk-input" type="text" autofocus></div><div class="uk-modal-footer uk-text-right"><button class="uk-button uk-button-default uk-modal-close" type="button">' +
                    n.labels.cancel +
              ...
              r.$el
                .on("submit", "form", function (t) {
                  t.preventDefault(), s(a.val()), (o = !0), r.hide();
                })
                .on("hide", function () {
                  o || s(null);
                });
    ...
    We = function (t) {
      t.component("navbar", {
        ...
        computed: {
          boundary: function () {
            return !0 === this.$props.boundary || this.boundaryAlign
              ? this.$el
              : this.$props.boundary;
          },
          pos: function () {
        ...
        ready: function () {
          this.dropbar &&
            t.navbarDropbar(
              y(this.dropbar, this.$el) ||
                St("<div></div>").insertAfter(this.dropbarAnchor || this.$el),
              {
        ...
        update: function () {
          t.drop(
            St(this.dropdown + " ." + this.clsDrop, this.$el),
            Rt({}, this.$props, { boundary: this.boundary, pos: this.pos })
          );
        },
        events: [
          {
        ...
        methods: {
          getActive: function () {
            ...
            return e && "click" !== e.mode && u(e.toggle.$el, this.$el) && e;
          },
        },
      }),
        t.component("navbar-dropbar", {
          ...
          events: [
            {
              ...
              handler: function (t, e) {
                var i = e.$el;
                if ("bottom" === e.dir && !u(i, this.$el))
                  return i.appendTo(this.$el), e.show(), !1;
              },
            },
            {
              name: "mouseleave",
            ...
            },
            {
              ...
              handler: function (t, e) {
                var i = e.$el;
                this.clsDrop && i.addClass(this.clsDrop + "-dropbar"),
                  this.transitionTo(i.outerHeight(!0));
              },
            },
            {
              name: "beforehide",
          ...
          methods: {
            transitionTo: function (t) {
              ...
              return (
                this.$el.height(
                  this.$el[0].offsetHeight ? this.$el.height() : 0
                ),
                Mt.cancel(this.$el).then(function () {
                  return Mt.start(e.$el, { height: t }, e.duration).then(
                    null,
                    X
                  );
                })
    ...
    Re = function (t) {
      t.component("offcanvas", {
        ...
        computed: {
          content: function () {
            return St(y(this.$props.content, this.$el));
          },
          clsFlip: function () {
          ...
          clsSidebarAnimation: function () {
            return "none" === this.mode || "reveal" === this.mode
              ? ""
              : this.$props.clsSidebarAnimation;
          },
          clsContentAnimation: function () {
            return "push" !== this.mode && "reveal" !== this.mode
              ? ""
              : this.$props.clsContentAnimation;
          },
          transitionElement: function () {
          ...
          write: function () {
            this.isToggled() &&
              ...
              this.overlay &&
                ...
                ke && this.content.scrollTop(ke.y)));
          },
          events: ["resize"],
        },
        events: [
          {
            ...
            handler: function (t) {
              var e = t.currentTarget;
              e.hash &&
                this.content.find(e.hash).length &&
                ((ke = null), this.hide());
            },
          },
          {
            ...
            self: !0,
            handler: function () {
              (ke = ke || { x: window.pageXOffset, y: window.pageYOffset }),
                "reveal" !== this.mode ||
                  this.panel.parent().hasClass(this.clsMode) ||
          ...
          },
          {
            ...
            handler: function () {
              if (
                ("reveal" === this.mode && this.panel.unwrap(), this.overlay)
              ) {
                if (!ke) {
              ...
              } else ke = { x: window.pageXOffset, y: window.pageYOffset };
      ...
      t.component("responsive", {
        ...
        update: {
          ...
          write: function () {
            this.dim &&
              this.$el.height(
                jt.contain({ height: this.height, width: this.width }, this.dim)
                  .height
              );
          },
          events: ["load", "resize"],
        ...
        events: {
          click: function (t) {
            t.isDefaultPrevented() ||
              (t.preventDefault(),
              this.scrollTo(
                St(this.$el[0].hash).length ? this.$el[0].hash : "body"
              ));
          },
        },
      }),
        (St.easing.easeOutExpo =
          St.easing.easeOutExpo ||
          function (t, e, i, n, s) {
    ...
    Ue = function (t) {
      t.component("scrollspy", {
        ...
        computed: {
          elements: function () {
            return (this.target && St(this.target, this.$el)) || this.$el;
          },
        },
        update: [
          {
          ...
          },
          {
            read: function () {
              ...
              this.elements.each(function (e, i) {
                if (!i._scrollspy) {
                  var n = St(i).attr("uk-scrollspy-class");
              ...
              this.elements.each(function (i, n) {
                ...
                if (o.show) {
                  if (!o.inview && !o.timer) {
                    ...
                    t.delay && e ? (o.timer = setTimeout(a, t.delay * e)) : a(),
                      e++;
                  }
                } else
                  o.inview &&
                    t.repeat &&
                    (o.timer && (clearTimeout(o.timer), delete o.timer),
                    s
                      .removeClass(t.inViewClass)
                      .toggleClass(r)
                      .css("visibility", t.hidden ? "hidden" : "")
                      .trigger("outview"),
                    t.$update(),
                    (o.inview = !1));
              });
          ...
          },
          {
            read: function () {
              var t = this,
                ...
                i = v() - window.innerHeight + this.offset;
              (this.active = !1),
                this.targets.each(function (n, s) {
                  var o = ht((s = St(s))),
                    r = n + 1 === t.targets.length;
                  if (
                    !t.overflow &&
                    ((0 === n && o > e) || (r && o + s[0].offsetTop < e))
                  )
                    return !1;
                  if (r || !(ht(t.targets.eq(n + 1)) <= e)) {
                    if (e >= i)
                      for (var a = t.targets.length - 1; a > n; a--)
                        if (g(t.targets.eq(a))) {
                          s = t.targets.eq(a);
                          break;
                        }
                    return !(t.active = j(
                      t.links.filter('[href="#' + s.attr("id") + '"]')
                    ));
                  }
                });
            },
              ...
              this.links.blur(),
                ...
                this.active &&
                  this.$el.trigger("active", [
                    this.active,
                    (this.closest
                      ? this.active.closest(this.closest)
                      : this.active
                    ).addClass(this.cls),
                  ]);
            },
    ...
    Qe = function (e) {
      e.component("sticky", {
        ...
        computed: {
          selTarget: function () {
            return (
              (this.$props.selTarget && j(this.$props.selTarget, this.$el)) ||
              this.$el
            );
          },
        },
        connected: function () {
          (this.placeholder = St('<div class="uk-sticky-placeholder"></div>')),
          ...
          if (this.target && location.hash && window.pageYOffset > 0) {
            ...
            e &&
              Vt(function () {
                ...
                n + s >= i &&
                  n <= i + e[0].offsetHeight &&
                  window.scrollTo(0, i - s - t.target - t.offset);
              });
          }
        },
        events: [
        ...
        update: [
          {
            write: function () {
              var e,
                i = this,
                n = (this.isActive ? this.placeholder : this.$el)[0]
                  .offsetHeight;
              this.placeholder
                .css("height", "absolute" !== this.$el.css("position") ? n : "")
                .css(
                  this.$el.css([
                    "marginTop",
                    "marginBottom",
                ...
                document.documentElement.contains(this.placeholder[0]) ||
                  this.placeholder.insertAfter(this.$el).attr("hidden", !0),
                (this.width = this.widthElement.attr(
                  "hidden",
                  null
                )[0].offsetWidth),
                ...
                ["top", "bottom"].forEach(function (n) {
                  (i[n] = i.$props[n]),
                    i[n] &&
                      (t.isNumeric(i[n])
                        ? (i[n] = i[n + "Offset"] + parseFloat(i[n]))
                        : N(i[n]) && i[n].match(/^-?\d+vh$/)
                        ? (i[n] = (window.innerHeight * parseFloat(i[n])) / 100)
                        : (e = !0 === i[n] ? i.$el.parent() : y(i[n], i.$el)) &&
                          (i[n] = ht(e) + e[0].offsetHeight));
                }),
                (this.top =
                  Math.max(parseFloat(this.top), this.topOffset) - this.offset),
                ...
                if (
                  ...
                  (this.isActive = !1),
                    this.animation && n > this.topOffset
                      ? Pt.cancel(this.$el)
                          .then(function () {
                            return Pt.out(e.$el, e.animation);
                          })
                          .then(function () {
                            return e.hide();
                          })
                  ...
                  this.isActive
                    ? this.update()
                    : this.animation
                    ? Pt.cancel(this.$el).then(function () {
                        e.show(), Pt.in(e.$el, e.animation);
                      })
                    : this.show();
            },
            events: ["scroll"],
        ...
        methods: {
          ...
          hide: function () {
            (this.isActive && !this.$hasClass(this.clsActive)) ||
          ...
          update: function () {
            ...
            this.bottom &&
              ...
              this.$hasClass(this.clsActive)
                ? i || this.$el.trigger("inactive")
                : i && this.$el.trigger("active"),
    ...
    Ze = function (e) {
      e.component("svg", {
                    ...
                    if (e) {
                      if (t.icon)
                        if ((s = e.getElementById(t.icon))) {
                          ...
                          if (!r) {
                            ...
                            a.appendChild(s.cloneNode(!0)), (r = a.innerHTML);
                          }
                          (r = r
                            .replace(
                              /<symbol/g,
                            ...
                            (o = Ge.parseFromString(
                              r,
                              "image/svg+xml"
                            ).documentElement);
                        } else
                          e.querySelector("symbol") ||
                            (o = e.documentElement.cloneNode(!0));
                      ...
                      if (o) {
                        ...
                        l &&
                          ((l = l.split(" ")),
                          (t.width = t.width || l[2]),
                          (t.height = t.height || l[3])),
                          (t.width *= t.ratio),
                          (t.height *= t.ratio);
                        for (var h in t.$options.props)
                          t[h] &&
                            !~t.exclude.indexOf(h) &&
                            o.setAttribute(h, t[h]);
                        t.id || o.removeAttribute("id"),
                          t.width && !t.height && o.removeAttribute("height"),
                          t.height && !t.width && o.removeAttribute("width");
                        var c = t.$el[0];
                        b(c) || "CANVAS" === c.tagName
                          ? (t.$el.attr({ hidden: !0, id: null }),
                            c.nextSibling
                              ? o.isEqualNode(c.nextSibling)
                                ? (o = c.nextSibling)
                                : c.parentNode.insertBefore(o, c.nextSibling)
                              : c.parentNode.appendChild(o))
                          : c.lastChild && o.isEqualNode(c.lastChild)
                          ? (o = c.lastChild)
                          : c.appendChild(o),
                          i(o);
                      } else n("SVG not found.");
                    } else n("SVG not found.");
                  });
                });
              })
        ...
        disconnected: function () {
          b(this.$el) && this.$el.attr({ hidden: null, id: this.id || null }),
            this.svg &&
        ...
        methods: {
          getSvg: function () {
            ...
            return this.src
              ? Je[this.src]
                ? Je[this.src]
                : ((Je[this.src] = C(function (i, n) {
                    0 === e.src.lastIndexOf("data:", 0)
                      ? i(e.parse(decodeURIComponent(e.src.split(",")[1])))
                      : t.ajax(e.src, { dataType: "html" }).then(
                          function (t) {
                            i(e.parse(t));
                          },
                          function () {
          ...
          parse: function (t) {
            var e = Ge.parseFromString(t, "image/svg+xml");
            return e.documentElement && "svg" === e.documentElement.nodeName
              ? e
              : null;
          },
        },
    ...
    Ke = function (t) {
      t.component("switcher", {
        ...
        computed: {
          connects: function () {
            return (
              y(this.connect, this.$el) ||
              St(this.$el.next("." + this.clsContainer))
            );
          },
          toggles: function () {
            return St(this.toggle, this.$el);
          },
        },
        events: [
          {
          ...
          },
          {
            ...
            handler: function (t) {
              t.preventDefault(),
                this.show(
                  St(t.currentTarget)[
                    t.currentTarget.hasAttribute(this.attrItem)
                      ? "attr"
                      : "data"
                  ](this.attrItem)
                );
        ...
        update: function () {
          this.updateAria(this.connects.children()),
            this.show(
              j(this.toggles.filter("." + this.cls + ":first")) ||
                j(this.toggles.eq(this.active)) ||
                this.toggles.first()
            );
        },
        methods: {
          show: function (t) {
            for (
              var e,
                ...
                s = this.connects.children("." + this.cls).index(),
                o = s >= 0,
                r = w(t, this.toggles, s),
                a = "previous" === t ? -1 : 1,
                l = 0;
              l < n;
              l++, r = (r + a + n) % n
            ...
            !e ||
              (s >= 0 && e.hasClass(this.cls)) ||
              s === r ||
              (this.toggles.removeClass(this.cls).attr("aria-expanded", !1),
              e.addClass(this.cls).attr("aria-expanded", !0),
              o
                ? this.toggleElement(
                    this.connects.children(
                      ":nth-child(" + (s + 1) + "),:nth-child(" + (r + 1) + ")"
                    )
                  )
                : this.toggleNow(
                    this.connects.children(":nth-child(" + (r + 1) + ")")
                  ));
          },
        },
      });
    ...
    ti = function (t) {
      t.component(
        ...
        t.components.switcher.extend({
          ...
          init: function () {
            var e =
              (this.$hasClass("uk-tab-left") && "uk-tab-left") ||
              (this.$hasClass("uk-tab-right") && "uk-tab-right");
            e &&
    ...
    ei = function (t) {
      t.component("toggle", {
        ...
        computed: {
          target: function () {
            return y(this.$props.target || this.href, this.$el) || this.$el;
          },
        },
        events: [
          {
            ...
            handler: function (t) {
              vt(t) ||
                this.toggle("toggle" + (t.type === te ? "show" : "hide"));
            },
          },
          {
            name: "click",
            filter: function () {
              return ~this.mode.indexOf("click") || Jt;
            },
            handler: function (t) {
              if (vt(t) || ~this.mode.indexOf("click")) {
                var e = St(t.target).closest("a[href]")[0];
                (St(t.target).closest('a[href="#"], button').length ||
                  (e &&
                    (this.cls ||
                      !this.target.is(":visible") ||
                      (e.hash && this.target.is(e.hash))))) &&
                  t.preventDefault(),
                  this.toggle();
              }
            },
        ...
        methods: {
          toggle: function (t) {
            a(this.target, t || "toggle", [this], !0).isDefaultPrevented() ||
      ...
      t.component("leader", {
        ...
        connected: function () {
          this.wrapper = this.$el
            .wrapInner('<span class="' + this.clsWrapper + '">')
            .children()
            .first();
        },
        disconnected: function () {
    ...
    ni = function (t) {
      t.component("video", {
        ...
        ready: function () {
          (this.player = new he(this.el)), this.automute && this.player.mute();
        },
        update: {
          write: function () {
            this.player &&
  ...
  return (
    ($e.version = "3.0.0-beta.28"),
    (function (t) {
      (t.mixin.class = Ce),
        (t.mixin.modal = Te),
        (t.mixin.position = Ae),
        (t.mixin.togglable = _e);
    })($e),
    (function (t) {
      var e = 0,
        i = 0;
      n(window, "load resize", t.update),
        n(window, "scroll", function (i) {
          (i.dir = e < window.pageYOffset ? "down" : "up"),
        ...
        ne &&
          n(
            ...
            function (t) {
              var e = t.target;
              (Q(e, "animationName") || "").match(/^uk-.*(left|right)/) &&
                (i++,
                (document.body.style.overflowX = "hidden"),
                setTimeout(function () {
                  --i || (document.body.style.overflowX = "");
                }, Y(Q(e, "animationDuration")) + 100));
            },
            !0
          ),
        t.use(ei),
    ...
    (function (t) {
        ...
        s(document.body, r),
          ...
          new Yt(function (e) {
            return e.forEach(function (e) {
              for (
                var i = e.addedNodes, n = e.removedNodes, o = e.target, l = 0;
                l < i.length;
                l++
              )
                s(i[l], r);
              for (l = 0; l < n.length; l++) s(n[l], a);
              t.update("update", o, !0);
            });
          }).observe(o, {
            childList: !0,
      ...
      Yt
        ...
        : i(function () {
            s(document.body, r),
              n(o, "DOMNodeInserted", function (t) {
                return s(t.target, r);
              }),
